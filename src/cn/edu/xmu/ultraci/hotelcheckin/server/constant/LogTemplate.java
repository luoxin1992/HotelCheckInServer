...
public class LogTemplate {
	...
	public static final String QUERY_STATUS_OK = "client %s query status info success, total %d statuses.";
	...
	// 房务
	public static final String NEW_GUEST_OK = "client %s upload guest with id %d success.";
	public static final String NEW_GUEST_FILE_NOT_FOUND = "client %s upload guest failure, idcard pic file %s not found.";
	public static final String CHECK_IN_OK = "client %s check in of room %d success.";
